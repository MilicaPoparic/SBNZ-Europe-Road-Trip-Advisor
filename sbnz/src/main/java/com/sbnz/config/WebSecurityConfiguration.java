...
import com.sbnz.security.auth.RestAuthenticationEntryPoint;
import com.sbnz.security.auth.TokenAuthenticationFilter;
...
public class WebSecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    public void configure(WebSecurity web) throws Exception {
        ...
        web.ignoring().antMatchers(HttpMethod.GET, "/api/category/**");
        web.ignoring().antMatchers(HttpMethod.POST, "/api/category/**");
