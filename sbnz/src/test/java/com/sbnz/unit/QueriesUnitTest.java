...
public class QueriesUnitTest {
	...
	public void setup() {
		...
		// Destinations
		Destination d1 = new Destination(1L, "Madrid", 40.41, -3.70, d1food, d1transport, 0.0, true, true, d1images);
		d1.setCategories(d1categories);
		d1.setHotels(d1hotels);
		Destination d2 = new Destination(2L, "London", 51.41, -0.12, d2food, d2transport, 0.0, true, true, d2images);
		d2.setCategories(d2categories);
		d2.setHotels(d2hotels);
		Destination d3 = new Destination(3L, "Paris", 48.41, 2.70, d3food, d3transport, 0.0, true, true, d3images);
	...
	@Test
	public void trendingDestinationsQuery() {
		...
		ArrayList<Destination> results = new ArrayList<Destination>();
	...
	@Test
	public void childrenDiscountDestinationsQuery() {
		...
		kieSession.getAgenda().getAgendaGroup("default").setFocus();
		kieSession.fireAllRules();
		QueryResults trendingDestinations = kieSession.getQueryResults("Get destinations with children discount", true);
		ArrayList<Destination> results = new ArrayList<Destination>();
		for (QueryResultsRow queryResult : trendingDestinations) {
			Destination d = (Destination) queryResult.get("$destinations");
			results.add(d);
	...
	@Test
	public void cityDestinationsQuery() {
		...
		kieSession.getAgenda().getAgendaGroup("default").setFocus();
		kieSession.fireAllRules();
		QueryResults trendingDestinations = kieSession.getQueryResults("Get destinations with selected category", "city");
		ArrayList<Destination> results = new ArrayList<Destination>();
		for (QueryResultsRow queryResult : trendingDestinations) {
			Destination d = (Destination) queryResult.get("$destinations");
			results.add(d);
	...
	@Test
	public void transportDestinationsQuery() {
		...
		kieSession.getAgenda().getAgendaGroup("default").setFocus();
		kieSession.fireAllRules();
		QueryResults trendingDestinations = kieSession.getQueryResults("Get destination with selected transportation type", Transportation.car);
		ArrayList<Destination> results = new ArrayList<Destination>();
		for (QueryResultsRow queryResult : trendingDestinations) {
			Destination d = (Destination) queryResult.get("$destinations");
			results.add(d);
	...
	@Test
	public void mediterraneanDestinationsQuery() {
		...
		kieSession.getAgenda().getAgendaGroup("default").setFocus();
		kieSession.fireAllRules();
		QueryResults trendingDestinations = kieSession.getQueryResults("Get mediterranean destinations");
		ArrayList<Destination> results = new ArrayList<Destination>();
		for (QueryResultsRow queryResult : trendingDestinations) {
			Destination d = (Destination) queryResult.get("$destinations");
			results.add(d);
	...
	@Test
	public void northDestinationsQuery() {
		...
		kieSession.getAgenda().getAgendaGroup("default").setFocus();
		kieSession.fireAllRules();
		QueryResults trendingDestinations = kieSession.getQueryResults("Get north europe destinations");
		ArrayList<Destination> results = new ArrayList<Destination>();
		for (QueryResultsRow queryResult : trendingDestinations) {
			Destination d = (Destination) queryResult.get("$destinations");
			results.add(d);
	...
	@Test
	public void easternDestinationsQuery() {
		...
		kieSession.getAgenda().getAgendaGroup("default").setFocus();
		kieSession.fireAllRules();
		QueryResults trendingDestinations = kieSession.getQueryResults("Get eastern europe destinations");
		ArrayList<Destination> results = new ArrayList<Destination>();
		for (QueryResultsRow queryResult : trendingDestinations) {
			Destination d = (Destination) queryResult.get("$destinations");
			results.add(d);
	...
	@Test
	public void balkanDestinationsQuery() {
		...
		kieSession.getAgenda().getAgendaGroup("default").setFocus();
		kieSession.fireAllRules();
		QueryResults trendingDestinations = kieSession.getQueryResults("Get balkan destinations");
		ArrayList<Destination> results = new ArrayList<Destination>();
		for (QueryResultsRow queryResult : trendingDestinations) {
			Destination d = (Destination) queryResult.get("$destinations");
			results.add(d);
